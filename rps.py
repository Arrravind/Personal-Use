...
def r_p_s():
    ...
    if p1==p2:
        lab2=Label(root, text="Nobody won",relief="flat",bg="lightblue")
...
def endf():
    final=Entry(root,justify="center",width=30,relief="flat",bg="yellow")
    final.grid(row=7,column=1)
    if player1_wins>player2_wins:
        final.insert(0,"Player 1 Wins The Game !!")
    elif player2_wins>player1_wins:
        final.insert(0,"Player 2 Wins The Game !!")
    else:
        final.insert(0,"Its a Tie")            
